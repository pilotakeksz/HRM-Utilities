...
class EmbedBuilder {
    ...
    setupEventListeners() {
        ...
        // Sidebar buttons
        document.getElementById('add-embed-btn').addEventListener('click', () => this.addEmbed());
    ...
    addEmbed() {
        ...
        this.currentEmbedIndex = this.embeds.length - 1;
        this.render();
    }
    ...
    duplicateEmbed() {
        ...
        const currentEmbed = JSON.parse(JSON.stringify(this.embeds[this.currentEmbedIndex]));
        this.embeds.splice(this.currentEmbedIndex + 1, 0, currentEmbed);
    ...
    deleteEmbed() {
        ...
        this.embeds.splice(this.currentEmbedIndex, 1);
        if (this.currentEmbedIndex >= this.embeds.length) {
            this.currentEmbedIndex = this.embeds.length - 1;
        }
        this.render();
    }
    ...
    addField() {
        ...
        this.embeds[this.currentEmbedIndex].fields.push(field);
        this.renderFields();
        this.renderPreview();
    }
    ...
    updateField(fieldIndex, property, value) {
        ...
        const field = this.embeds[this.currentEmbedIndex].fields[fieldIndex];
        if (property === 'inline') {
    ...
    deleteField(fieldIndex) {
        ...
        this.embeds[this.currentEmbedIndex].fields.splice(fieldIndex, 1);
        this.renderFields();
        this.renderPreview();
    }
